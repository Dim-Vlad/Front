...
if (!$existing) { http_response_code(404); echo json_encode(['error' => 'Partenaire introuvable.']); exit; }
...
if ($nom === '' || !in_array($categorie, $validCategories, true)) {
    http_response_code(400); echo json_encode(['error' => 'Nom et catégorie requis.']); exit;
}
