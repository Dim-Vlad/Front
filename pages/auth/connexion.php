...
$isInscription = $defaultTab === 'inscription';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    <div class="login-wrapper">
        <div class="auth-container<?= $isInscription ? ' auth-container--active' : '' ?>" id="auth-container">

            <!-- ── Formulaire Connexion ── -->
            <div class="auth-form-box auth-form-box--login" id="panel-login">
                <div class="auth-form-inner">
                    ...
                    <p class="auth-switch-link"><span>Pas encore de compte ?</span> <button type="button" onclick="switchTab('inscription')">Créer mon compte</button></p>
                </div>
            </div>

            <!-- ── Formulaire Inscription ── -->
            <div class="auth-form-box auth-form-box--inscription" id="panel-inscription">
                <div class="auth-form-inner">
                    ...
                    <p class="auth-switch-link"><span>Déjà un compte ?</span> <button type="button" onclick="switchTab('login')">Se connecter</button></p>
                </div>
            </div>

            <!-- ── Panneau coulissant (logo + texte) ── -->
            <div class="auth-overlay-container" id="auth-overlay">
                <div class="auth-overlay">
                    <div class="auth-overlay-panel auth-overlay-panel--left">
                        <img src="/images/logo-club/Logo-VBO-blanc.png" alt="Logo VBO" class="auth-overlay-logo">
                        <h2>Déjà membre ?</h2>
                        <p>Connectez-vous pour retrouver votre tableau de bord, vos équipes et vos entraînements.</p>
                        <button type="button" class="btn-ghost" onclick="switchTab('login')">Se connecter</button>
                    </div>
                    <div class="auth-overlay-panel auth-overlay-panel--right">
                        <img src="/images/logo-club/Logo-VBO-blanc.png" alt="Logo VBO" class="auth-overlay-logo">
                        <h2>Pas encore de compte ?</h2>
                        <p>Créez votre compte pour rejoindre la communauté du Volley Ball Ollioulais et accéder à votre espace membre.</p>
                        <button type="button" class="btn-ghost" onclick="switchTab('inscription')">Créer un compte</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function switchTab(tab) {
            document.getElementById('auth-container').classList.toggle('auth-container--active', tab === 'inscription');
        }
